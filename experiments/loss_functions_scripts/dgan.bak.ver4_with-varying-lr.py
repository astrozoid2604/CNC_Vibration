...
class DGAN:
    ...
    def _train(
        ...
        best_model_filepath      = self.cwd_path + best_model_filename
        ...
        checkpoint_filepath      = self.cwd_path + model_prefix + '.pth'
        ...
        while epoch < self.config.epochs:
            ...
            generator_loss, discriminator_loss, total_gendis_loss = 0.0, 0.0, 0.0
            ...
            generator_loss     /= len(loader)  #Averaged by batch_size
            discriminator_loss /= len(loader)  #Averaged by batch_size
